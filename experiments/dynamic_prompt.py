...
if __name__ == "__main__":
    ...
    information_retrievers = [FAISSRetriever(n=1,
                                             database="openbookqa",
    ...
    for language_model in language_models:
        for information_retriever in information_retrievers:
            for n in range(1, 6):
                ...
                save_results(f"./result/openbookqa/dynamic_prompting/{language_model}/{information_retriever}/dynamic_prompting_{n}_shot.json", results)
