...
if __name__ == "__main__":
    ...
    information_retrievers = [FAISSRetriever("openbookqa",
    ...
    for language_model in language_models:
        for information_retriever in information_retrievers:
            ...
            for n in range(1, 7):
                ...
                save_results(f"./result/openbookqa/permutations/{language_model}/{information_retriever}/permutations_{n}.json", results)
            ...
            save_results(f"./result/openbookqa/permutations/{language_model}/{information_retriever}/consistency_report.json",
