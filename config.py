...
from prompting.few_shot_prompt import ZeroShotUserEngagementPrompt, FewShotUserEngagmentPrompt, SarcasticConversationWithUserPrompt, ConversationWithUserPrompt

result_dir = "result"

class PIQARDConfig:
    large_language_model = BLOOM176bAPI()
    prompt_generator = ConversationWithUserPrompt()
